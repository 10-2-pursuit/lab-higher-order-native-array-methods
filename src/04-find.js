...
{
  const pinkElephants = songs.find( songs => songs.title.includes("Pink Elephants"));
...
{
  const underThreeMinutes = songs.find( songs => songs.runtimeInSeconds < 180 )
...
{
  const titleTrack = songs.find( songs => songs.album === songs.title )
  return titleTrack
}
