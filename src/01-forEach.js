 ...
 */ 
function printAllSongTitles(exampleSongData) {
  exampleSongData.forEach((song) => console.log(song['title']));
}
...
function printSongDetails(songs) {
  exampleSongData.forEach((song) => console.log(`${song['title']} by ${song['artist']}`));
}
